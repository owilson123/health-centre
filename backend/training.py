...
EXERCISES = [
    ...
    ("Seated Leg Raise",           "Core",  "Bodyweight"),
...
SCALE: dict[str, float | None] = {
    ...
    "Decline Barbell Bench Press":  0.92,
    "Close-Grip Bench Press":       0.80,
    "Paused Bench Press":           0.93,
    "Spoto Press":                  0.90,
    "Overhead Press":               0.64,
    "Push Press":                   0.75,
    "Landmine Press":               0.48,
    ...
    "Deadlift":                     1.55,
    "Sumo Deadlift":                1.55,
    "Deficit Deadlift":             1.45,
    "Rack Pull":                    1.70,
    "Romanian Deadlift":            1.10,
    "Trap Bar Deadlift":            1.60,
    "Dumbbell Row":                 0.55,
    "Chest-Supported Row":          0.50,
    "Reverse Fly":                  0.18,
    "Dumbbell Shrug":               0.65,
    "Dumbbell RDL":                 0.60,
    "Lat Pulldown":                 0.75,
    "Wide-Grip Lat Pulldown":       0.75,
    "Rope Lat Pulldown":            0.70,
    "Seated Cable Row":             0.75,
    "Single-Arm Cable Row":         0.40,
    "Face Pull":                    0.30,
    "Straight-Arm Pulldown":        0.35,
    "Cable Pullover":               0.38,
    "Cable Curl":                   0.25,
    "Pull-Up":                      None,
    "Chin-Up":                      None,
    ...
    "Concentration Curl":           0.15,
    "Spider Curl":                  0.16,
    "Zottman Curl":                 0.17,
    "Overhead Tricep Extension":    0.22,
    "Tricep Kickback":              0.12,
    "Tricep Pushdown":              0.25,
    "Rope Tricep Pushdown":         0.23,
    "Reverse Grip Pushdown":        0.22,
    "Overhead Cable Curl":          0.20,
    "Cable Hammer Curl":            0.18,
    "Bayesian Curl":                0.18,
...
DUMBBELL_PER_HAND = {
    ...
    "Dumbbell Fly", "Dumbbell Lateral Raise", "Dumbbell Front Raise", "Dumbbell Pullover",
    "Dumbbell Row", "Chest-Supported Row", "Reverse Fly", "Dumbbell Shrug", "Dumbbell RDL",
    "Dumbbell Lunge", "Walking Lunge", "Reverse Lunge", "Bulgarian Split Squat",
    "Dumbbell Step-Up", "Goblet Squat",
    "Dumbbell Curl", "Hammer Curl", "Incline Dumbbell Curl",
    "Concentration Curl", "Spider Curl", "Zottman Curl",
    "Overhead Tricep Extension", "Tricep Kickback",
    "Single-Arm Dumbbell Press", "Single-Arm Cable Row", "Single-Arm Cable Fly",
}
